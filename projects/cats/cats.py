...
def about(topic):
    ...
    def get_keywords(sentences):
        ...
        sentences2 = lower(sentences1)
        sentences3 = split(sentences2)
...
def autocorrect(typed_word, valid_words, diff_function, limit):
    ...
    for word in valid_words:
        ...
        dislist.append([word, dis])
    if min(dislist, key=lambda x: x[1])[1] > limit:
        return typed_word
    else:
        return min(dislist, key=lambda x: x[1])[0]
    # END PROBLEM 5
