class VendingMachine:
    ...
    def vend(self):
        if self.inv == 0:
            ...
            dprice = self.price - self.eprice
            if dprice > 0:
                return (f'You must add ${dprice} more funds.')
            elif dprice == 0:
                self.inv -= 1
                self.eprice = 0
                ...
                self.inv -= 1
                self.eprice = 0
                return (f'Here is your {self.name} and ${abs(dprice)} change.')

    def restock(self, num):
        self.inv += num
        return (f'Current {self.name} stock: {self.inv}')
    ...
    def add_funds(self, money):
        if self.inv == 0:
            ...
            self.eprice += money
            return (f'Current balance: ${self.eprice}')
...
def is_bst(t):
    ...
    if len(t.branches) == 1:
        ...
        return bst_min(t) <= t.label < bst_max(t) and is_bst(t.branches[0]) and is_bst(t.branches[1])
