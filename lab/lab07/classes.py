...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        opponent_card.defense,opponent_card.attack = opponent_card.attack,opponent_card.defense
    def copy(self):
        """
        Create a copy of this card.
        """
...
class ProfessorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        for op in opponent.deck.cards[:]:
            if op.defense == op.attack:
                opponent.deck.cards.remove(op)
